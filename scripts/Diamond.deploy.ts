...
export async function deployDiamond() {
  ...
  verifyCommands.push(`yarn hardhat verify --network ${network.name} ${diamondCutFacet.address}`);
  ...
  verifyCommands.push(`yarn hardhat verify --network ${network.name} ${diamond.address} ${contractOwner.address} ${diamondCutFacet.address}`);
  ...
  verifyCommands.push(`yarn hardhat verify --network ${network.name} ${diamondInit.address}`);
  ...
  for (const FacetName of FacetNames) {
    ...
    verifyCommands.push(`yarn hardhat verify --network ${network.name} ${facet.address}`);
